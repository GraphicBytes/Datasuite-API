var field_html_<?php echo $field_id; ?> = '<input id="ppat-<?php echo $field_name; ?>" class="ppat-text ppat-text-<?php echo $field_name; ?> ppat-text-<?php echo $field_id; ?>" name="<?php echo $field_name; ?>" value="" placeholder="<?php echo htmlentities($placeholder, ENT_QUOTES); ?>" type="text">';
...
if(ppat_form_basic_found == 1){
  ...
  html = html + '<div class="ppat-form-row ppat-form-row-textfield ppat-form-row-<?php echo $field_name; ?> ppat-form-row-<?php echo $field_id; ?>">';
...
if(ppat_form_basic_found == 0){
  ...
  if(document.body.contains(document.getElementById('ppat-<?php echo $form_id; ?>-<?php echo $field_name; ?>'))){
    ...
    $("#ppat-<?php echo $form_id; ?>-<?php echo $field_name; ?>").addClass("ppat-form-row-textfield");
