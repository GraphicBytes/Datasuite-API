   ...
   # ========================================================================#
		...
		Class resize
		{
			...
			function __construct($fileName)
			{
				...
				if($this->is_gd_image($this->image)){
			...
			private function crop($optimalWidth, $optimalHeight, $newWidth, $newHeight)
			{
				...
				$this->imageResized = imagecreatetruecolor(round($newWidth) , round($newHeight));
				imagealphablending( $this->imageResized, false );
				imagesavealpha( $this->imageResized, true );
				imagecopyresampled($this->imageResized, $crop , 0, 0, round($cropStartX), round($cropStartY), round($newWidth), round($newHeight) , round($newWidth), round($newHeight));
			}
